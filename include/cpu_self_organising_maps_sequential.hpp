...
namespace gpu_self_organising_maps {
    ...
    // The class of CPU's Self-Organising Maps Sequential
    class cpu_self_organising_maps_sequential {
        ...
        public:
            ...
            // The Constructor of CPU's Self-Organising Maps Sequential:
            cpu_self_organising_maps_sequential(const unsigned ncols, const unsigned nrows,
